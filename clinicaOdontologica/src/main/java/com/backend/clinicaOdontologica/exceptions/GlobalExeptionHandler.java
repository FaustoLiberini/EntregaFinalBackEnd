...
public class GlobalExeptionHandler {
    ...
    public Map<String, String> mensajeResourseNotFound(ResourceNotFoundException resourceNotFoundException) {
    ...
    public Map<String, String> mensajeBadRequest(BadRequestException badRequestException) {
        Map<String, String> mensaje = new HashMap<>();
